...
class Producto extends Conexion
{
	...
	{
        $sql="insert into producto(descripcion,precio,id_categoria) values('$this->descripcion',
        '$this->precio','$this->id_categoria')";
	...
	id_categoria='$this->id_categoria' where id_producto=$this->id_producto";		
		if(parent::ejecutar($sql))
			return true;
		else
			return false;	
   ...
   //metodos utilizados para el comboBox
	...
	{
		$sql="select id_producto,descripcion,precio,nombre from producto,categoria 
		where categoria.id_categoria=producto.id_categoria and id_producto like '$criterio%'";
		return parent::ejecutar($sql);
	}								
	...
	{
		$sql="select id_producto,descripcion,precio,nombre from producto,categoria 
		where categoria.id_categoria=producto.id_categoria and descripcion like '$criterio%'";
		return parent::ejecutar($sql);
	}
}    
?>