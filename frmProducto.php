...
<input name="txtIdProducto" type="hidden"  value="<?php if(isset($_GET['pid_producto'])){ echo $_GET['pid_producto'];}?>" 
  ...
  <table width="400" border="1">
    <tr>
      ...
      <td width="225">	 	  
        <input name="txtDescripcion" type="text"  value="<?php if(isset($_GET['pdescripcion'])){ echo $_GET['pdescripcion'];}?>" 
        id="txtDescripcion" />
      </td>
    </tr>    
     <tr>
      ...
      <td width="225">	  	  
        <input name="txtPrecio" type="text" value="<?php if(isset($_GET['pprecio'])){ echo $_GET['pprecio'];}?>" id="txtPrecio" />
      </td>
    </tr>
    ...
    <tr>
      ...
      <td width="225">	  	          
      <input name="txtNombreCat" type="text" value="<?php if(isset($_SESSION['nombre_cat'])){ echo $_SESSION['nombre_cat'];}?>" id="txtNombreCat" />
      <a href="#" onClick="abreBuscarCategoria()">Buscar</a>	
      <input name="txtIdCategoria" type="text" readonly="true" size="3" 
      value="<?php if(isset($_SESSION['id_categoria'])){ echo $_SESSION['id_categoria'];}?>" id="txtIdCategoria" />
     </td>
	</tr>
   ...
   <tr>
	...
	<td colspan="2">
      Buscar por       
      <input name="grupo" type="radio" value="1" checked="checked" <?php if(isset($_GET['grupo'])){if ($_POST['grupo']=="1") echo "checked";} ?> />
      Codigo
      <input type="radio" name="grupo" value="2" <?php if(isset($_GET['grupo'])){if ($_POST['grupo']=="2") echo "checked";} ?>/>
      Nombre
      <input name="txtBuscar" type="text" id="txtBuscar" value="<?php if(isset($valor)){ echo $valor;}?>" size="33"/>   
     </td>
    </tr>
  </table>
</form>
